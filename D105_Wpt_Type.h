// D105_Wpt_Type.h : Declaration of the CD105_Wpt_Type

#ifndef __D105_WPT_TYPE_H_
#define __D105_WPT_TYPE_H_
...
/////////////////////////////////////////////////////////////////////////////
// CD105_Wpt_Type
class ATL_NO_VTABLE CD105_Wpt_Type : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CD105_Wpt_Type, &CLSID_D105_Wpt_Type>,
	public ISupportErrorInfo,
	public CBodyPacketImpl,
	public IDispatchImpl<ID105_Wpt_Type, &IID_ID105_Wpt_Type, &LIBID_GARMINLib>
{
public:
	CD105_Wpt_Type()
	{
...
DECLARE_REGISTRY_RESOURCEID(IDR_D105_WPT_TYPE)

DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CD105_Wpt_Type)
	COM_INTERFACE_ENTRY(ID105_Wpt_Type)
	COM_INTERFACE_ENTRY(ISupportErrorInfo)
	COM_INTERFACE_ENTRY2(IDispatch, ID105_Wpt_Type)
	COM_INTERFACE_ENTRY2(IGarminDataType, ID105_Wpt_Type)

	COM_INTERFACE_ENTRY2(IDXXX_Wpt_Type, ID105_Wpt_Type)
	COM_INTERFACE_ENTRY(IBodyPacket)	
	COM_INTERFACE_ENTRY(IHelperBodyPacket)
END_COM_MAP()

BEGIN_CATEGORY_MAP(CD105_Wpt_Type)
...
private:
	...
	GARMIN_TYPES::D105_Wpt_Type m_gdata;
	_bstr_t	m_ident;
};

#endif //__D105_WPT_TYPE_H_
