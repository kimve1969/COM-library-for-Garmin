// D152_Wpt_Type.h : Declaration of the CD152_Wpt_Type

#ifndef __D152_WPT_TYPE_H_
#define __D152_WPT_TYPE_H_
...
/////////////////////////////////////////////////////////////////////////////
// CD152_Wpt_Type
class ATL_NO_VTABLE CD152_Wpt_Type : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CD152_Wpt_Type, &CLSID_D152_Wpt_Type>,
	public ISupportErrorInfo,
	public CBodyPacketImpl,
	public IDispatchImpl<ID152_Wpt_Type, &IID_ID152_Wpt_Type, &LIBID_GARMINLib>
{
public:
	CD152_Wpt_Type()
	{
...
DECLARE_REGISTRY_RESOURCEID(IDR_D152_WPT_TYPE)

DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CD152_Wpt_Type)
	COM_INTERFACE_ENTRY(ID152_Wpt_Type)
	COM_INTERFACE_ENTRY(ISupportErrorInfo)
	COM_INTERFACE_ENTRY2(IDispatch, ID152_Wpt_Type)
	COM_INTERFACE_ENTRY2(IGarminDataType, ID152_Wpt_Type)

	COM_INTERFACE_ENTRY2(IDXXX_Wpt_Type, ID152_Wpt_Type)
	COM_INTERFACE_ENTRY(IBodyPacket)	
	COM_INTERFACE_ENTRY(IHelperBodyPacket)
END_COM_MAP()

BEGIN_CATEGORY_MAP(CD152_Wpt_Type)
...
private:
	...
	GARMIN_TYPES::D152_Wpt_Type m_gdata;
	_bstr_t	m_ident;
};

#endif //__D152_WPT_TYPE_H_
