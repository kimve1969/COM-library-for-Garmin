// D109_Wpt_Type.h : Declaration of the CD109_Wpt_Type

#ifndef __D109_WPT_TYPE_H_
#define __D109_WPT_TYPE_H_
...
/////////////////////////////////////////////////////////////////////////////
// CD109_Wpt_Type
class ATL_NO_VTABLE CD109_Wpt_Type : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CD109_Wpt_Type, &CLSID_D109_Wpt_Type>,
	public ISupportErrorInfo,
	public CBodyPacketImpl,
	public IDispatchImpl<ID109_Wpt_Type, &IID_ID109_Wpt_Type, &LIBID_GARMINLib>
{
public:
	CD109_Wpt_Type()
	{
...
DECLARE_REGISTRY_RESOURCEID(IDR_D109_WPT_TYPE)

DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CD109_Wpt_Type)
	COM_INTERFACE_ENTRY(ID109_Wpt_Type)
	COM_INTERFACE_ENTRY(ISupportErrorInfo)
	COM_INTERFACE_ENTRY2(IDispatch, ID109_Wpt_Type)
	COM_INTERFACE_ENTRY2(IGarminDataType, ID109_Wpt_Type)

	COM_INTERFACE_ENTRY2(IDXXX_Wpt_Type, ID109_Wpt_Type)
	COM_INTERFACE_ENTRY(IBodyPacket)	
	COM_INTERFACE_ENTRY(IHelperBodyPacket)
END_COM_MAP()

BEGIN_CATEGORY_MAP(CD109_Wpt_Type)
...
private:
	...
	GARMIN_TYPES::D109_Wpt_Type m_gdata;
	_bstr_t	m_ident;
};

#endif //__D109_WPT_TYPE_H_
