// D103_Wpt_Type.h : Declaration of the CD103_Wpt_Type

#ifndef __D103_WPT_TYPE_H_
#define __D103_WPT_TYPE_H_
...
/////////////////////////////////////////////////////////////////////////////
// CD103_Wpt_Type
class ATL_NO_VTABLE CD103_Wpt_Type : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CD103_Wpt_Type, &CLSID_D103_Wpt_Type>,
	public ISupportErrorInfo,
	public CBodyPacketImpl,
	public IDispatchImpl<ID103_Wpt_Type, &IID_ID103_Wpt_Type, &LIBID_GARMINLib>
{
public:
	CD103_Wpt_Type()
	{
...
DECLARE_REGISTRY_RESOURCEID(IDR_D103_WPT_TYPE)

DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CD103_Wpt_Type)
	COM_INTERFACE_ENTRY(ID103_Wpt_Type)
	COM_INTERFACE_ENTRY(ISupportErrorInfo)
	COM_INTERFACE_ENTRY2(IDispatch, ID103_Wpt_Type)
	COM_INTERFACE_ENTRY2(IGarminDataType, ID103_Wpt_Type)

	COM_INTERFACE_ENTRY2(IDXXX_Wpt_Type, ID103_Wpt_Type)
	COM_INTERFACE_ENTRY(IBodyPacket)	
	COM_INTERFACE_ENTRY(IHelperBodyPacket)
END_COM_MAP()

BEGIN_CATEGORY_MAP(CD103_Wpt_Type)
...
private:
	...
	GARMIN_TYPES::D103_Wpt_Type m_gdata;
	_bstr_t	m_ident;
};

#endif //__D103_WPT_TYPE_H_
